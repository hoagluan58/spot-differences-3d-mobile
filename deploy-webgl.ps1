...
Write-Host "  Spot Differences 3D — WebGL Deploy"    -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "  https://hoagluan58.github.io/spot-differences-3d-mobile/" -ForegroundColor White
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
